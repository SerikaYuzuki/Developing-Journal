...
**Cauchy の積分定理から留数定理へ進む。** [Cauchy の積分公式の節](#math2f-liouville-theory)では、特異点のない領域なら閉路積分が $0$ になることを示した。特異点 $z_j$ がある場合は、それぞれを小円 $C_j$ でくり抜き、外周 $C$ と小円を細いブリッジで結ぶ。ブリッジの往復は打ち消し合うため
